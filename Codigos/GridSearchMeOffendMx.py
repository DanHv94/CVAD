...
print("100")
X_MeOffendEsMx_train, y_MeOffendEsMx_train = load_features("..\\Corpus\\MeOffendEs\\OffendMex\\MeOffendEsMx_train_features_v2_100.txt")
#X_MeOffendEsMx_train, y_MeOffendEsMx_train = load_features("..\\Corpus\\MeOffendEs\\OffendMex\\MeOffendEsMx_train_features_v2_3.txt")
'''
...
grid = GridSearchCV(LogisticRegression(max_iter = 5000),param_grid,refit="f1_macro",verbose=3,scoring=["f1_macro", "f1_micro","f1","accuracy"])
grid.fit(X_MeOffendEsMx_train, y_MeOffendEsMx_train)

print("100. Mejores parámetros:",grid.best_params_)
print("Mejor resutado:",grid.best_score_)
